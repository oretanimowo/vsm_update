<?php
    ...
    include("./path.php");
    include("./admin/validate/contact_us.php");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>VSM | Contact Page Vehicle Overview</title>
    ...
    <style>
        ...
        .hero {
            background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.3)), url(assets/images/cars/car-1.jpg);
            background-position: center;
            background-size: 100%;
        }
    </style>
...
<body>
    <div id="wrapper">
        ...
        <div class="hero">
            <div class="hero-img">
                <!-- <img src="assets/images/cars/car-1.jpg" alt="" style="width: 100%;"> -->
            </div>
        ...
        <div class="contact">
            <div class="contact-text">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, dicta.</p>
            </div>
            <div class="contact-container space-between">
                <div class="contact-form">
                    <form action="" method="post">
                        ...
                        <div class="form-group center">
                            <input type="submit" value="Send Message" class="why-btn" name="submit">
                        </div>
                    </form>
                </div>
